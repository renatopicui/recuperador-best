/*
  # Atualizar expiração do checkout para 15 minutos
  
  1. Alterações
    - Modificar o default da coluna expires_at na tabela checkout_links de 30 minutos para 15 minutos
    - Atualizar a função generate_checkout_links_for_pending_payments para usar 15 minutos
...
-- Alterar o default da coluna expires_at para 15 minutos
ALTER TABLE checkout_links 
ALTER COLUMN expires_at SET DEFAULT (NOW() + INTERVAL '15 minutes');

-- Recriar função de geração de checkout com expiração de 15 minutos
